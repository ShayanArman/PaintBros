...
export const zeroBlueOldButtonShadowDark = "0 0 18px 0 color-mix(in srgb, var(--zero-blue-old) 55%, transparent),0 0 23px 0 color-mix(in srgb, var(--zero-blue-old) 38%, transparent)";
