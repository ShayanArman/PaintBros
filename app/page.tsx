...
function AboutFeatureCheckmark() {
  return (
    <div
      ...
      onMouseLeave={(event) => {
        event.currentTarget.style.boxShadow = zeroBlueOldButtonShadow;
      }}
    >
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden">
      <div
        ...
        style={{ backgroundImage: "url('/homeBackgroundScroll.jpg')" }}
      />
      ...
      <div className="relative z-10">
        ...
        {/* Hero Section: add_background_image homeBackgroundScroll.jpg */}
      ...
      <section id="about" className="py-20 bg-white">
        ...
        {/* Services Section: add_background_image homeBackgroundScroll.jpg */}
      ...
      <section className="py-20 bg-black text-white">
        ...
        {/* Contact Section: add_background_image homeBackgroundScroll.jpg */}
        <section id="contact" className="relative py-20">
          <div aria-hidden="true" className="absolute inset-0 bg-white/84" />
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
