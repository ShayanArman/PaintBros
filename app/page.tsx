        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-gray-900">Paint Bros Vancouver</h1>
            </div>
            ...
            <a href="tel:7783874513" className="bg-black text-white px-6 py-2 rounded-lg hover:bg-gray-800 transition-colors">
              Call Now
            </a>
          </div>
        </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-900">Vancouver, BC & Surrounding Areas</p>
                </div>
              </div>
            </div>
